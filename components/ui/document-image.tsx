  ...
  ({ className, containerClassName, variant = "default", ...props }, ref) => {
    ...
    const variants = {
      default: {
        ...
        image:
          "object-contain bg-white border border-gray-200 rounded-lg shadow-sm",
      },
      preview: {
        container:
          "relative w-full flex justify-center bg-gray-50 p-4 rounded-lg",
        image:
          "object-contain bg-white border border-gray-300 rounded shadow-lg",
      },
      full: {
        container: "relative w-full flex justify-center",

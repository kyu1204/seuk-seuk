export default {
  ...
  "dashboard.publications.empty.title": "No documents sent yet",
  "dashboard.publications.empty.description": "Publish a draft to generate a signing link.",
  "dashboard.publications.empty.action": "Publish a draft",

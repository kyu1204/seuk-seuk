export default {
  ...
  "upload.page.title": "Upload a document",
  "upload.page.description": "Upload a PDF or photo and mark where signers should sign.",
  "upload.dropzone.title": "Drop your document here",
  "upload.meta": "{{pages}} pages · {{signatures}} signature areas, {{texts}} text areas",
  "upload.areaHint": "Pick an area type, then drag on the document to place it.",
  "upload.areaList": "Areas ({{count}})",
  "upload.saveAndPublish": "Save & publish",
  "upload.saved": "Saved",
  "upload.noAreas.title": "No signature areas yet",
  "upload.noAreas.description": "If you save without any areas, the recipient will have nowhere to sign. Save anyway?",
  "upload.noAreas.addAreas": "Add areas",
  "upload.noAreas.saveAnyway": "Save anyway",
  "upload.error.tooLarge": "This file is too large. Please upload a file under 50MB.",
  "upload.error.unsupported": "Unsupported file. Only PDF, JPG, PNG, WEBP and GIF are allowed.",
  "upload.error.uploadFailed": "Could not upload the file. Check your connection and try again.",
  ...
  "upload.dragDrop": "Click to choose a file or drag it here · PDF, JPG, PNG, WEBP · up to 50MB",
  ...
  "sign.clickAreas": "Tap a purple box to sign or type",
  ...
  "home.bento.title": "Everything you need, inside one link",
  "home.bento.description": "Light for the signer, all in one place for you.",
  "home.bento.signer.title": "Signers just tap the link",
  "home.bento.signer.description": "No account, no app. They sign on their phone, and one signature fills every matching field.",
  "home.bento.templates.title": "Templates remember the fields",
  "home.bento.templates.description": "Set up a frequent document once and reuse it.",
  "home.bento.bundle.title": "Several documents, one link",
  "home.bento.bundle.description": "Bundle a contract and its consent form into a single send.",
  "home.bento.lock.title": "Password and expiry",
  "home.bento.lock.description": "Only the right people, only until the date you set.",
  "home.bento.pdf.title": "Signed PDFs kept for you",
  "home.bento.pdf.description": "The signed PDF is ready the moment everyone is done.",
  "home.bento.progress.title": "See who has signed what",
  "home.bento.progress.description": "Track every document from the dashboard.",
  "home.art.sign": "Sign",
  "home.art.viewed": "Viewed",
  "home.art.oneLink": "1 link",
  "home.art.doc": "Document {{n}}",
  ...
  "sign.area.labelText": "Text field {{index}}",
  ...
  "templates.delete.confirmTitle": "Delete the '{{name}}' template?",
  "templates.delete.confirmDescription": "Documents already made from this template will stay; only the template goes away.",
  "templates.delete.confirm": "Delete template",
  "templates.delete.success": "Template deleted",
  "templates.delete.error": "Couldn't delete the template. Please try again.",
  "templates.publish.success": "Published. Go ahead and share the link.",
  "templates.error.load": "Couldn't load templates.",
  "templates.empty.title": "Have a document you reuse often?",
  "templates.empty.description": "Save it once and you won't need to re-mark signature fields every time.",
  ...
  "templates.create.dropDescription": "Upload a document to reuse as a template and define its signature areas.",
  "templates.create.name": "Template name",
  "templates.create.nameDefault": "Defaults to file name",
  "templates.create.namePlaceholder": "Enter a template name (e.g., Contract, Consent Form)",
  "templates.create.save": "Save template",
  "templates.create.saving": "Saving template...",
  ...
  "dashboard.empty.action": "Upload document",
  ...
  "dashboard.tabs.publications": "Requests",
  "dashboard.tabs.templates": "Templates",
  "dashboard.publications.empty.title": "No signing requests sent yet",
  "dashboard.publications.empty.description": "Publish a document to create a signing request link.",
  "dashboard.publications.empty.action": "Publish a document",
  "dashboard.publications.error.load": "Couldn't load publications.",
  "dashboard.publications.delete.error": "Couldn't delete the publication. Please try again.",
  "dashboard.publications.delete.success": "Signing request deleted.",
  ...
  "dashboard.publications.delete.title": "Delete signing request",
  "dashboard.publications.delete.description": "Delete the signing request \"{name}\"?",
  "dashboard.publications.delete.warning": "All documents in this publication will return to draft status.",
  "dashboard.publications.delete.warningReset": "Every signature received so far will be lost. The documents return to drafts and the shared link stops working.",
  "dashboard.publications.delete.warningCompleted": "Completed requests and their documents are archived, not deleted; they just leave this list.",
  ...
  "dashboard.publications.bulkDelete.cannotDelete": "Only completed publications can be deleted",
  ...
  "dashboard.bulkDelete.confirmDelete": "Delete {{count}}",
  "dashboard.bulkDelete.progress": "Deleting {{done}}/{{total}}…",
  ...
  "bills.noSubscription.title": "You don't have a plan yet",
  "bills.noSubscription.description":
    "Subscribe to a plan to unlock document limits and templates.",
  "bills.noSubscription.action": "Browse plans",
  "bills.noTransactions": "No payment history yet.",
  "bills.created": "Created",
  "bills.historyDescription": "History of completed signed documents.",
  "bills.totalDocuments": "{{count}} total",
  "bills.viewDetails": "View details",
  "bills.noDocuments.title": "No completed documents yet",
  "bills.noDocuments.description": "Documents appear here once signing is complete.",
  "bills.noDocuments.action": "Upload a document",
  ...
  "publicationDetail.updateError": "Couldn't save the publication. Please try again.",
  ...
  "documentDetail.delete.title": "Delete document",
  "documentDetail.delete.confirm": "Delete the '{{name}}' document?",
  "documentDetail.delete.description": "The document and its signature fields will be deleted together and cannot be undone.",
  ...
  "publish.description": "Bundle selected documents into a single link. Recipients can sign right from the link.",
  ...
  "publish.errorPublishing": "Couldn't publish. Please try again in a moment.",
  "publish.name": "Publication Name",
  "publish.namePlaceholder": "e.g., September contract · Jiwoo Kim",
  "publish.nameHint": "Shown at the top of the recipient's screen.",
  "publish.password": "Password",
  "publish.password.optional": "Optional",
  "publish.passwordPlaceholder": "Required password to access signature page",
  "publish.passwordHint": "Set one so only people who know it can view the document.",
  "publish.expiration": "Expiration Date",
  "publish.expirationPlaceholder": "Select signature expiration date",
  "publish.expirationHint": "The link stops working after this date.",
  "publish.documentSelection": "Select Documents",
  "publish.documents.title": "Documents to send",
  "publish.documents.count": "{{selected}} of {{total}} drafts selected",
  "publish.documents.meta": "{{pages}} pages · {{signatures}} signature areas",
  "publish.documents.noAreas": "No areas · Add signature areas before publishing",
  "publish.selectAll": "Select All",
  "publish.deselectAll": "Deselect All",
  "publish.cancel": "Cancel",
  "publish.submit": "Create link",
  "publish.submitting": "Creating link…",
  "publish.success": "Link created. Share it with the recipient.",
  ...
  // My Page
  "mypage.title": "Account",
  "mypage.profile.title": "Profile",
  "mypage.profile.email": "Email",
  "mypage.profile.name": "Name",
  "mypage.profile.emailHint": "Used for sign-in and notifications.",
  "mypage.profile.joinedAt": "Joined",
  "mypage.profile.nameHint": "Signers see this name on their signing request.",
  "mypage.profile.nameRequired": "Enter a name.",
  "mypage.profile.saving": "Saving…",
  "mypage.profile.saved": "Name saved.",
  "mypage.profile.saveError": "Could not save the name. Please try again.",
  "mypage.profile.save": "Save changes",
  "mypage.plan.title": "Plan & usage",
  "mypage.plan.summary": "{{plan}} plan · next payment {{date}}",
  "mypage.plan.free": "Basic plan · free",
  "mypage.plan.manage": "Manage billing",
  ...
  "mypage.dangerZone.title": "Delete account",
  "mypage.dangerZone.deleteAccount": "Delete account",
  "mypage.dangerZone.deleteWarning":
    "Deleting your account permanently removes your documents, signed copies, and templates. Wrap up any in-progress publications first.",

export default {
  ...
  "upload.error.unsupported": "Unsupported file. Only PDF, JPG, PNG and WEBP are allowed.",
  ...
  "upload.dragDrop": "Click to choose a file or drag it here · PDF, JPG, PNG · up to 10MB",

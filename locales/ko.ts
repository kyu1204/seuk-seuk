export default {
  ...
  "dashboard.tabs.publications": "발행됨",
  "dashboard.tabs.templates": "템플릿",
  "dashboard.publications.empty.title": "아직 보낸 문서가 없어요",
  "dashboard.publications.empty.description": "초안을 발행하면 서명 링크가 만들어집니다.",
  "dashboard.publications.empty.action": "초안 발행하기",
  "dashboard.publications.error.load": "발행 목록을 불러오지 못했습니다.",
  "dashboard.publications.delete.error": "발행을 삭제하지 못했습니다. 다시 시도해 주세요.",

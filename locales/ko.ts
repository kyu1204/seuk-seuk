export default {
  ...
  "upload.page.title": "문서 올리기",
  "upload.page.description": "PDF나 사진을 올리고 서명받을 칸을 지정하세요.",
  "upload.dropzone.title": "여기에 문서를 놓으세요",
  "upload.meta": "{{pages}}쪽 · 서명 칸 {{signatures}}개, 텍스트 칸 {{texts}}개",
  "upload.areaHint": "칸을 고른 뒤 문서 위에서 끌어서 놓으세요.",
  "upload.areaList": "지정한 칸 {{count}}",
  "upload.saveAndPublish": "저장하고 발행하기",
  "upload.saved": "저장했어요",
  "upload.noAreas.title": "서명 칸이 없어요",
  "upload.noAreas.description": "칸 없이 저장하면 받는 사람이 서명할 곳이 없습니다. 그래도 저장할까요?",
  "upload.noAreas.addAreas": "칸 지정하기",
  "upload.noAreas.saveAnyway": "그대로 저장",
  "upload.error.tooLarge": "파일이 너무 큽니다. 50MB 이하로 올려 주세요.",
  "upload.error.unsupported": "지원하지 않는 파일입니다. PDF, JPG, PNG, WEBP, GIF만 올릴 수 있어요.",
  "upload.error.uploadFailed": "파일을 올리지 못했습니다. 네트워크를 확인하고 다시 시도해 주세요.",
  ...
  "upload.dragDrop": "클릭해서 파일을 고르거나 끌어다 놓으세요 · PDF, JPG, PNG, WEBP · 최대 50MB",
  "upload.button": "문서 선택",
  "upload.clear": "지우기",
  ...
  "home.bento.title": "링크 하나에 필요한 게 다 들어 있습니다",
  "home.bento.description": "받는 사람은 가볍게, 보내는 사람은 한 곳에서.",
  "home.bento.signer.title": "받는 사람은 링크만 누르면 끝",
  "home.bento.signer.description": "가입도 설치도 없이 휴대폰에서 바로 서명합니다. 같은 서명이 여러 칸이면 한 번에 채워요.",
  "home.bento.templates.title": "템플릿은 서명 칸까지 기억",
  "home.bento.templates.description": "자주 쓰는 문서는 한 번만 만들어 두세요.",
  "home.bento.bundle.title": "여러 문서를 링크 하나로",
  "home.bento.bundle.description": "계약서와 동의서를 묶어서 한 번에 보냅니다.",
  "home.bento.lock.title": "비밀번호와 유효기간",
  "home.bento.lock.description": "아는 사람만, 정해진 날짜까지만 열립니다.",
  "home.bento.pdf.title": "서명본 PDF 자동 보관",
  "home.bento.pdf.description": "끝나면 서명이 들어간 PDF가 바로 준비됩니다.",
  "home.bento.progress.title": "누가 어디까지 서명했는지",
  "home.bento.progress.description": "대시보드에서 진행 상황을 한눈에 봅니다.",
  "home.art.sign": "서명",
  "home.art.viewed": "열람함",
  "home.art.oneLink": "링크 1개",
  "home.art.doc": "문서 {{n}}",
  ...
  "sign.completed.noEdit": "제출하면 서명을 수정할 수 없습니다.",
  ...
  "sign.progress.title": "서명한 문서를 만드는 중이에요",
  ...
  "sign.remainingChip": "남은 칸 {{count}}곳",
  ...
  "sign.zoomIn": "확대",
  "sign.zoomOut": "축소",
  "sign.zoomReset": "원래 크기",
  "sign.area.labelText": "입력 칸 {{index}}",
  "sign.area.label": "서명 칸 {{index}}",
  "sign.area.signedAlt": "서명됨",
  "sign.submit.remaining": "서명 {{count}}곳을 더 채우면 제출할 수 있어요",
  "sign.submit.confirmTitle": "문서를 제출할까요?",
  "sign.submit.confirmDescription": "제출한 뒤에는 서명을 바꿀 수 없습니다.",
  "sign.submit.confirm": "제출하기",
  "sign.error.saveSignature": "서명을 저장하지 못했습니다. 다시 시도해 주세요.",
  "sign.error.upload": "서명한 문서를 만들지 못했습니다. 다시 시도해 주세요.",
  "sign.error.loadDocument": "문서를 불러오지 못했습니다. 새로고침해 주세요.",
  "sign.batchSignConfirmPage": "이 쪽의 남은 {{count}}곳에 같은 서명을 넣습니다. 계속할까요?",
  "sign.batchSign.partial":
    "{{done}}곳은 적용했고 {{failed}}곳은 실패했어요. 실패한 칸을 다시 눌러 주세요.",
  "sign.pdf.loadError": "문서를 여는 데 실패했습니다. 다시 시도하거나 다른 기기에서 열어 주세요.",
  "sign.pdf.memoryError": "문서를 여는 데 실패했습니다. 다시 시도하거나 다른 기기에서 열어 주세요.",
  ...
  "dashboard.header.description": "문서를 올리고 서명을 받아보세요.",
  "dashboard.publish": "발행하기",
  ...
  "templates.delete": "삭제",
  "templates.delete.confirmTitle": "'{{name}}' 템플릿을 삭제할까요?",
  "templates.delete.confirmDescription": "템플릿으로 만든 문서는 남고, 템플릿만 사라집니다.",
  "templates.delete.confirm": "템플릿 삭제",
  "templates.delete.success": "템플릿을 삭제했어요",
  "templates.delete.error": "템플릿을 삭제하지 못했습니다. 다시 시도해 주세요.",
  "templates.publish.success": "발행했어요. 링크를 공유해 보세요.",
  "templates.error.load": "템플릿을 불러오지 못했습니다.",
  "templates.empty.title": "반복해서 쓰는 문서가 있나요?",
  "templates.empty.description": "한 번 저장해 두면 매번 서명 칸을 다시 잡지 않아도 됩니다.",
  ...
  "templates.create.dropDescription": "템플릿으로 재사용할 문서를 업로드하고 서명 영역을 지정하세요.",
  "templates.create.name": "템플릿 이름",
  "templates.create.nameDefault": "미입력 시 파일명 사용",
  "templates.create.namePlaceholder": "템플릿 이름을 입력하세요 (예: 근로계약서, 동의서 등)",
  "templates.create.save": "템플릿 저장",
  "templates.create.saving": "템플릿 저장 중...",
  ...
  "dashboard.filter.published": "발행됨",
  "dashboard.filter.completed": "완료",
  "dashboard.tabs.documents": "문서",
  "dashboard.tabs.publications": "서명 요청",
  "dashboard.tabs.templates": "템플릿",
  "dashboard.publications.empty.title": "아직 보낸 서명 요청이 없어요",
  "dashboard.publications.empty.description": "문서를 발행하면 서명 요청 링크가 만들어집니다.",
  "dashboard.publications.empty.action": "문서 발행하기",
  "dashboard.publications.error.load": "발행 목록을 불러오지 못했습니다.",
  "dashboard.publications.delete.error": "서명 요청을 삭제하지 못했습니다. 다시 시도해 주세요.",
  "dashboard.publications.delete.success": "서명 요청을 삭제했어요.",
  ...
  "dashboard.publications.delete.title": "서명 요청 삭제",
  "dashboard.publications.delete.description": "\"{name}\" 서명 요청을 삭제할까요?",
  "dashboard.publications.delete.warning": "이 발행에 포함된 모든 문서는 초안 상태로 돌아갑니다.",
  "dashboard.publications.delete.warningReset": "이미 받은 서명이 모두 사라집니다. 문서는 초안으로 되돌아가고, 공유한 링크는 더 이상 열리지 않습니다.",
  "dashboard.publications.delete.warningCompleted": "완료된 서명 요청과 문서는 삭제되지 않고 보관함으로 옮겨져 목록에서만 사라집니다.",
  ...
  "dashboard.bulkDelete.confirmDelete": "{{count}}개 삭제",
  "dashboard.bulkDelete.progress": "{{done}}/{{total}} 삭제 중…",
  ...
  "bills.noSubscription.title": "현재 이용 중인 플랜이 없어요",
  "bills.noSubscription.description":
    "플랜을 구독하면 문서 한도와 템플릿을 쓸 수 있어요.",
  "bills.noSubscription.action": "플랜 둘러보기",
  "bills.noTransactions": "아직 결제 내역이 없어요.",
  "bills.created": "생성일",
  "bills.historyDescription": "완료된 서명 문서 내역입니다.",
  "bills.totalDocuments": "총 {{count}}건",
  "bills.viewDetails": "자세히 보기",
  "bills.noDocuments.title": "완료된 문서가 없어요",
  "bills.noDocuments.description": "서명이 완료되면 이곳에 문서가 표시됩니다.",
  "bills.noDocuments.action": "문서 올리기",
  ...
  "publicationDetail.status.expired": "만료",
  ...
  "documentDetail.delete.title": "문서 삭제",
  "documentDetail.delete.confirm": "'{{name}}' 문서를 삭제할까요?",
  ...
  "publish.nameHint": "받는 사람 화면 맨 위에 보입니다.",
  "publish.password": "비밀번호",
  "publish.password.optional": "선택",
  "publish.passwordPlaceholder": "서명 페이지 접근 시 필요한 비밀번호",
  "publish.passwordHint": "걸어 두면 비밀번호를 아는 사람만 문서를 볼 수 있어요.",
  "publish.expiration": "만료일",
  "publish.expirationPlaceholder": "서명 만료 날짜를 선택하세요",
  "publish.expirationHint": "이 날짜가 지나면 링크가 열리지 않습니다.",
  "publish.documentSelection": "문서 선택",
  "publish.documents.title": "보낼 문서",
  "publish.documents.count": "초안 {{total}}개 중 {{selected}}개 선택",
  "publish.documents.meta": "{{pages}}쪽 · 서명 {{signatures}}",
  "publish.documents.noAreas": "칸 없음 · 발행 전 서명 칸을 지정하세요",
  "publish.selectAll": "전체 선택",
  "publish.deselectAll": "전체 해제",
  "publish.cancel": "취소",
  "publish.submit": "링크 만들기",
  "publish.submitting": "링크 만드는 중…",
  "publish.success": "링크를 만들었어요. 받는 사람에게 공유하세요.",
  ...
  // My Page
  "mypage.title": "계정",
  "mypage.profile.title": "프로필",
  "mypage.profile.email": "이메일",
  "mypage.profile.name": "이름",
  "mypage.profile.emailHint": "로그인과 알림에 사용됩니다.",
  "mypage.profile.joinedAt": "가입일",
  "mypage.profile.nameHint": "서명 요청을 받는 사람에게 이 이름이 보입니다.",
  "mypage.profile.nameRequired": "이름을 입력해 주세요.",
  "mypage.profile.saving": "저장 중…",
  "mypage.profile.saved": "이름을 저장했어요.",
  "mypage.profile.saveError": "이름을 저장하지 못했습니다. 다시 시도해 주세요.",
  "mypage.profile.save": "변경 사항 저장",
  "mypage.plan.title": "플랜과 사용량",
  "mypage.plan.summary": "{{plan}} 플랜 · 다음 결제 {{date}}",
  "mypage.plan.free": "베이직 플랜 · 무료",
  "mypage.plan.manage": "결제 관리",
  ...
  "mypage.dangerZone.title": "계정 삭제",
  "mypage.dangerZone.deleteAccount": "계정 삭제",
